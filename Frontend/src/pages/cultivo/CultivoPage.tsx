...
const CultivoPage: React.FC = () => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    e.preventDefault();
    if (cultivo.nombre && cultivo.unidad_medida_id && cultivo.fecha_siembra && cultivo.especie_id && cultivo.bancal_id) {
    ...
    <DefaultLayout>
      ...
      />
       <div>
                    ...
                    <select
                        value={cultivo.unidad_medida_id}
                        onChange={(e) => setCultivo({ ...cultivo, unidad_medida_id: Number(e.target.value)})}
        ...
        <ReuInput
          ...
          onChange={(e) =>
            setCultivo({ ...cultivo, fecha_siembra: e.target.value })
          }
        />
        <div className="mb-1">
          <div className="flex items-center gap-2 mb-1">
